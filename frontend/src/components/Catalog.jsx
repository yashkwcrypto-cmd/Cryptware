        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          >
            ...
            <div className="px-6 py-4 border-t border-paper-3/40 bg-white/90 backdrop-blur-md flex justify-end gap-3 sticky bottom-0 z-20">
              ...
              <button 
                onClick={() => {
                  const message = `Hello Cryptware team,\n\nI am interested in your "${selectedItem.title}". Please send me more details, pricing, and availability.`;
                  window.open(`https://wa.me/917490971996?text=${encodeURIComponent(message)}`, '_blank');
                }}
                className="text-[0.75rem] font-bold uppercase tracking-widest bg-[#25D366] hover:bg-[#128C7E] text-white px-5 py-2.5 rounded-lg shadow-sm hover:shadow hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2"
              >
                WhatsApp
