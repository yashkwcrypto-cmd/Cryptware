  ...
  return (
    <section ref={containerRef} id="services" className="py-20 md:py-32 bg-paper group/services" onMouseMove={handleMouseMove}>
      <div className="w-[92%] max-w-[1280px] mx-auto">
        ...
        {/* SERVICES GRID - responsive columns for smaller screens */}
        <div className="services-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
                  ...
                  >
                    ...
                    <div className="relative z-10 flex-1">
                      ...
                      <button
                        ...
                        className="absolute -top-2 -right-2 w-12 h-12 border-[1.5px] border-brand/20 rounded-full flex items-center justify-center opacity-100 transition-all duration-300 ease-ease-back bg-white text-brand shadow-[0_10px_20px_rgba(13,110,253,0.12)] hover:bg-brand hover:text-white hover:border-brand cursor-pointer z-20"
