...
function SendMessageModal({ initialMessage = '', onClose }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Note: The first time you submit this form, FormSubmit will send an activation link to info@cryptwareinfotech.com
      const response = await fetch('https://formsubmit.co/ajax/info@cryptwareinfotech.com', {
        method: 'POST',
        headers: {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="ctc-item flex flex-col sm:flex-row gap-3">
                ...
                <a
                  href="https://mail.google.com/mail/?view=cm&fs=1&to=info@cryptwareinfotech.com&su=Project%20Inquiry"
                  target="_blank"
