...
import FloatingChat from "../common/wrappers/FloatingChat";
import CustomCursor from "../common/wrappers/CustomCursor";
      ...
      >
        {brands.map((brand, i) => (
          ...
          >
            ...
            />
            <span className="text-[0.72rem] font-bold tracking-[0.16em] text-white/55 uppercase">
              {brand.name}
            </span>
          </div>
        ))}
...
function AnimatedStat({ end, label, suffix = "" }) {
  ...
  return (
    <div ref={ref} className="text-center">
      ...
      <p className="text-xs text-white/45 mt-2 tracking-[0.16em] uppercase font-semibold">
        {label}
      </p>
    </div>
  );
    ...
    <div className="relative min-h-screen bg-[#0b0f1e] font-sans text-white overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex flex-col justify-center overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(rgba(6,163,218,1) 1px,transparent 1px),linear-gradient(90deg,rgba(6,163,218,1) 1px,transparent 1px)",
            ...
            <div>
              ...
              <h1 className="text-[clamp(2.8rem,5.2vw,5rem)] font-bold text-white leading-[1.04] tracking-tight mb-6">
                ...
                <span className="relative inline-block">
                  <span className="bg-gradient-to-r from-[#06a3da] to-[#38bdf8] bg-clip-text text-transparent italic">
                    Move Faster.
                  </span>
                  <svg
              ...
              <p className="text-white/55 text-[1.05rem] leading-[1.82] max-w-[520px] font-light mb-10">
                Complete catalog of barcode printers, scanners, mobile
                computers, POS systems, RFID solutions, and labels — trusted by
                enterprises across retail, healthcare, manufacturing &amp;
                logistics.
              </p>
              ...
              <div className="flex flex-wrap gap-6">
                {[
                  ...
                  <div
                    key={b.text}
                    className="flex items-center gap-2 text-white/40 text-[0.72rem] font-semibold uppercase tracking-widest"
                  >
            ...
            <div className="relative flex flex-col gap-4">
              ...
              <div className="bg-white/[0.04] border border-white/[0.1] rounded-3xl p-7 backdrop-blur-sm">
                ...
                <div className="flex items-center justify-between border-b border-white/[0.08] pb-4 mb-6">
                  ...
                  <span className="text-[0.65rem] font-bold uppercase tracking-[0.14em] text-white/30">
                    CW-HW-01
                  </span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-5 mb-6">
                  {[
                    ...
                    <div key={s.label} className="flex flex-col gap-1.5">
                      ...
                      <p className="text-white/40 text-[0.65rem] uppercase tracking-wider">
                        {s.label}
                      </p>
                    </div>
                  ))}
                ...
                <div className="border-t border-white/[0.08] pt-5">
                  <p className="text-[0.62rem] text-white/30 uppercase tracking-[0.2em] mb-3 font-bold">
                    Top Brands
                  </p>
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 z-10">
          <span className="text-white/20 text-[0.62rem] uppercase tracking-[0.2em]">
            Scroll
          </span>
      ...
      <section id="catalog" className="py-28 bg-[#f8faff]">
        <div className="w-[92%] max-w-[1280px] mx-auto">
          <div className="text-center mb-16">
            <span className="block text-[#06a3da] tracking-[0.22em] uppercase text-[0.7rem] font-bold mb-4">
            ...
            <p className="text-[#64748b] mt-5 max-w-[560px] mx-auto leading-relaxed text-[0.95rem]">
              From print-and-apply automation to real-time RFID inventory —
              every hardware need covered under one roof.
            </p>
          </div>
                ...
                >
                  ...
                  <div className="relative h-[210px] overflow-hidden flex-shrink-0">
                    <img
                      ...
                      onError={(e) => {
                        e.target.src = "/assets/img/mainlogo_3(1).jpg";
                      }}
                    />
      ...
      <section className="py-24 bg-white">
        <div className="w-[92%] max-w-[1280px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <span className="block text-[#06a3da] tracking-[0.2em] uppercase text-[0.7rem] font-bold mb-5">
                Barcode &amp; Labeling Solutions
              </span>
              <h2 className="text-4xl md:text-[2.75rem] font-bold text-[#0b0f1e] leading-[1.1] mb-6">
                Labels for Every Surface,
                <br />
                Industry, and Environment
              </h2>
              <p className="text-[#64748b] leading-relaxed mb-8 text-[0.95rem]">
                From plain paper rolls to pharmaceutical-grade FDA-compliant
                labels, polyester asset tags, jewelry price tags, food-safe
                labels, and tamper-evident security seals — our barcode
                consumables portfolio covers every labeling need in any
                industry.
              </p>
              <div className="grid grid-cols-2 gap-4 mb-8">
                {[
                  {
                    label: "Barcode Labels & Tags",
                    desc: "Paper, polyester, polypropylene & specialty materials",
                    Icon: Icon.Label,
                  },
                  {
                    label: "Thermal Transfer Ribbons",
                    desc: "Wax, wax-resin, and resin ribbons for all printers",
                    Icon: Icon.Zap,
                  },
                  {
                    label: "Specialty Labels",
                    desc: "Food-safe, medical, security & industrial variants",
                    Icon: Icon.Shield,
                  },
                  {
                    label: "Custom Printing",
                    desc: "Pre-printed with your brand, sequential numbers",
                    Icon: Icon.FileText,
                  },
                ].map((item) => (
                  <div
                    key={item.label}
                    className="p-4 rounded-2xl bg-[#f8faff] border border-[#e2e8f0] hover:border-[#06a3da]/30 hover:shadow-sm transition-all duration-300 group"
                  >
                    <item.Icon className="w-4 h-4 text-[#06a3da] mb-2" />
                    <p className="font-bold text-[0.85rem] text-[#0b0f1e] mb-1">
                      {item.label}
                    </p>
        ...
        <div className="relative z-10 w-[92%] max-w-[1280px] mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white leading-tight">
              Powering Operations{" "}
              <span className="text-[#06a3da]">Worldwide</span>
            </h2>
            <p className="text-white/40 mt-5 max-w-[500px] mx-auto leading-relaxed text-sm">
              Tailored hardware solutions for every vertical — from pharma clean
              rooms to busy retail floors.
            </p>
          </div>
            ...
            {hardwareIndustries.map((industry) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-bold text-white text-[0.95rem] mb-2">
                    {industry.name}
                  </h3>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="relative z-10 w-[92%] max-w-[900px] mx-auto text-center">
          ...
          <p className="text-[#64748b] text-lg mb-12 max-w-[520px] mx-auto leading-relaxed">
            Browse every product model, request a custom quote, and get
            dedicated support from our hardware specialists.
          </p>
