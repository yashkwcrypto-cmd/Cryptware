...
export default function MobileMenu({ isOpen, onClose, onNavCatalog }) {
  ...
  return (
    <>
      ...
      {/* Drawer Menu */}
      <div
        className={`fixed top-0 right-0 w-full max-w-[340px] h-full bg-[#fafaf8] z-50 flex flex-col p-8 sm:p-12 gap-8 shadow-[-10px_0_30px_rgba(11,11,15,0.05)] border-l border-paper-3 transition-transform duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] ${isOpen ? 'translate-x-0' : 'translate-x-full'
          }`}
      >
